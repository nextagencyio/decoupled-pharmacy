...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Cornerstone Pharmacy. Contact us for prescription transfers, immunization appointments, or questions about our services.',
  keywords: ['Contact Pharmacy', 'Pharmacy Support', 'Prescription Transfer', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our pharmacy services? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@cornerstonepharmacy.com</p>
                    <p className="text-gray-600">support@cornerstonepharmacy.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 345-6728</p>
